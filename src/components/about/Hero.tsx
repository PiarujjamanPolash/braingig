...
const Hero: React.FC = () => {
    ...
    return (
        <div className="td-about-area pt-[100px] lg:pt-[120px]">
            <AnimateTwoContent
            ...
            <div className="container mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-5">
                    ...
                    <div className="hidden lg:block w-full px-4 md:px-0 lg:row-start-auto lg:col-start-1">
                        <div ref={thumbRef}
                        ...
                        >
                            ...
                            <div className="flex flex-col md:flex-row -mx-4">
                                ...
                                <div className="w-full md:w-12/12 px-4">
                                    <div className="td-about-main-text mt-3 lg:mt-7 text-center md:text-start flex flex-col items-center md:items-start">

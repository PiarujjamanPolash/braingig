...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="">
      <div className="td-footer-area pt-[110px] pb-[15px] td-footer-3-bg">
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <TextFadeInUp textRef={textRef} />
              <div ref={textRef} className="td-footer-3-widget footer-anim">
                <h2  className="td-footer-3-bigtitle ">
            ...
            {/* Middle Section */}
            <div className="w-full lg:w-1/4 md:w-1/2 px-4 mb-[30px]">
              <div className="td-footer-3-widget">
                <h4 className="td-footer-3-title mb-[15px]">Our Headquarter</h4>
                <Link className="links mb-[40px] inline-block" href="https://maps.app.goo.gl/gEGMdJo73A6GjNCS9" target="_blank">
                  4th Floor of NRB Bank Building<br />
                  Station Rd, Rajshahi 6100, Bangladesh
                </Link>
                <div className="td-footer-3-social flex space-x-4">
        ...
        <div className="container w-[90%] mx-auto">
          <div className="flex flex-wrap justify-center items-center">
            <div className="w-full lg:w-2/3 px-1">
              <div className="td-footer-3-menu mb-[30px]">
            ...
            <div className="w-full lg:w-1/3 px-4">
              <div className="td-footer-3-copyright mb-[30px] text-left lg:text-right">
                <p>

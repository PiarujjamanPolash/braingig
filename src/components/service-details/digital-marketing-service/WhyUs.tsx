    ...
    return (
        <section className='container w-[90%] mx-auto'>
            <div className='flex flex-col justify-center items-center gap-5 mb-15 lg:mb-20'>
                <h3 className='!text-[50px] lg:!text-[70px] td-text-invert'>Why Us</h3>
                <p className='w-[90%] md:w-[80%] lg:w-[70%] !text-lg text-center'>You get a complete, easy-to-understand plan, fast execution, and frequent optimization. The result: stronger rankings, lower acquisition costs, and steady pipeline growth.</p>
            </div>

            <div className="td-service-pin-items">
                {projectsData.map((project) => (
                    <div key={project.id} className="grid grid-cols-1 xl:grid-cols-12 gap-y-4 xl:gap-8 items-start mb-20 sm:mb-32 td-service-pin-item-panel bg-white">
                        <div className="xl:col-span-8 relative">
                            <h2 className="td-portfolio-6-transparent">0{project.id}</h2>
                        ...
                        <div className="xl:col-span-4 flex flex-col md:flex-row xl:flex-col gap-3 xl:gap-8 bg-white">
                            ...
                            <div className="bg-white border border-gray-200 rounded-xl p-6 md:w-1/2 lg:w-full">
                                <h2 className="!text-3xl font-semibold text-black mb-5 border-l-4 border-[#ff5722] pl-3">Strategy Overview</h2>
                            ...
                            {/* Results & Performance */}
                            <div className="bg-white border border-gray-200 rounded-xl p-6 md:w-1/2 lg:w-full">
                                <h2 className="!text-3xl font-semibold text-black mb-5 border-l-4 border-[#ff5722] pl-3">Results & Performance</h2>
                                <div className="space-y-5">
                                    <div className="flex justify-between md:justify-start lg:justify-between items-center gap-3 lg:gap-0">

            ...
            <div className="container mx-auto">
                <div className="flex flex-wrap -mx-4">
                    ...
                    <div className="w-full lg:w-7/12 px-4">
                        ...
                        >
                            <h3 className="td-about-main-title mb-5 lg:mb-5">Driving innovation through strategic consulting</h3>
                            ...
                            <div className="flex flex-col md:flex-row -mx-4">
                                ...
                                <div className="w-full md:w-7/12 px-4">
                                    <div className="td-about-main-text mt-7">
                                        <p className="mb-7">
                                        ...
                                        <div className="td-btn-group">
                                            ...
                                            <a className="td-btn-2 td-btn-primary" href="/contact">EXPLORE MORE</a>
                                            <a className="td-btn-circle" href="contact.html">
                                                <FaArrowRight />
                                            </a>
                                        </div>
